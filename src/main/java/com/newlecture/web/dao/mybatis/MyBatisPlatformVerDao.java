...
import com.newlecture.web.dao.PlatformVerDao;
...
public class MyBatisPlatformVerDao implements PlatformVerDao{
   ...
   @Override
   public List<PlatformVer> getList(int page, String feild, String query) {
      PlatformVerDao platformVerDao;
      platformVerDao = sqlSession.getMapper(PlatformVerDao.class);
      
      return platformVerDao.getList(page, feild, query);
   }
